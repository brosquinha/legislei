...
class TestCamaraDeputadosHelper(unittest.TestCase):

    def setUp(self):
        self.dep = CamaraDeputadosHelper()
        logging.disable(logging.CRITICAL)

    def tearDown(self):
        logging.disable(logging.NOTSET)

    @patch("legislei.houses.camara_deputados.CasaLegislativa.obterDataInicialEFinal")
    ...
    def test_get_all_events(
        ...
        self.assertEqual([
            Evento(
                id='123',
                data_inicial=self.dep.get_brt(datetime(2018, 10, 24, 10, 0)),
            ...
            Evento(
                id='1234',
                data_inicial=self.dep.get_brt(datetime(2018, 10, 24, 14, 0)),
            ...
            Evento(
                id='12345',
                data_inicial=self.dep.get_brt(datetime(2018, 10, 25, 10, 0)),
                data_final=None,
                situacao='Cancelada',
                nome='Sessão Ordinária',
                url='uri',
    ...
    def test_get_votes(
        ...
        actual_response = self.dep.get_votes(
            ...
            event_dates={
                'data_inicial': self.dep.get_brt(datetime(2019, 5, 12, 10)),
                'data_final': self.dep.get_brt(datetime(2019, 5, 12, 14))
            }
        )
    ...
    def test_get_propositions(
        ...
        actual_response = self.dep.get_propositions(
    ...
    def test_build_proposition(self):
        ...
        expected = Proposicao(
            id='123',
            data_apresentacao=self.dep.get_brt(datetime(2018, 10, 25)),
