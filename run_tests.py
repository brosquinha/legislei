...
from tests.integration.test_camara_deputados import TestCamaraDeputadosHandlerIntegration
from tests.integration.test_alesp import TestALESPHandlerIntegration
from tests.integration.test_camara_municipal_sao_paulo import TestCamaraMunicipalSaoPauloHandlerIntegration
...
from tests.unit.test_camara_municipal_sao_paulo import TestCamaraMunicipalSaoPauloHandler
